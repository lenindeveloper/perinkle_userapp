...
class ProductOrderDetailController extends GetxController
  ...
  Future<void> getAppointmentDetails() async {
    ...
    if (response.statusCode == 200) {
      ...
      fullAddres = _salonOrderInfo.address!.house! +
          ' ' +
          _salonOrderInfo.address!.landmark! +
          ' ' +
          _salonOrderInfo.address!.address! +
          ' ' +
          _salonOrderInfo.address!.pincode!;
                        ...
                        children: <Widget>[
                          Text(
                              salonOrderInfo.salonId != 0
                                  ...
                                  : salonOrderInfo.ownerInfo!.firstName! +
                                      ' ' +
                                      salonOrderInfo.ownerInfo!.lastName!,
                              style: const TextStyle(
