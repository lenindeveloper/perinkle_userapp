  ...
  Future<void> getAppointmentById() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (_appointmentDetail.salonId != 0) {
        ...
        freelancerName =
            _appointmentDetail.individualInfo!.firstName.toString() +
                ' ' +
                _appointmentDetail.individualInfo!.lastName.toString();
      }
  ...
  Future<void> getOrderDetails() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (_details.type == 'salon') {
        ...
        freelancerName = _details.freelancerInfo!.firstName.toString() +
            ' ' +
            _details.freelancerInfo!.lastName.toString();
      }
      debugPrint('freelancer id' + freelancerID);
      debugPrint('freelancer name' + freelancerName);
      _issueWithList = [];
