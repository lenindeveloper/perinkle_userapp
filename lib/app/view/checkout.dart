                  ...
                  value.savedInCart.services!.isNotEmpty
                      ? Row(
                          ...
                          children: [
                            ...
                            Text(
                                value.savedInCart.services!.length.toString() +
                                    ' ' +
                                    'Services'.tr,
                                style: const TextStyle(
                                    fontFamily: 'bold', fontSize: 14))
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: SizedBox.fromSize(
                                  ...
                                  child: FadeInImage(
                                    image: NetworkImage(
                                        '${Environments.apiBaseURL}storage/images/' +
                                            value.savedInCart.services![i].cover
                                                .toString()),
                  ...
                  value.savedInCart.packages!.isNotEmpty
                      ? Row(
                          ...
                          children: [
                            ...
                            Text(
                                value.savedInCart.packages!.length.toString() +
                                    ' ' +
                                    'Packages'.tr,
                                style: const TextStyle(
                                    fontFamily: 'bold', fontSize: 14))
                              ...
                              ClipRRect(
                                ...
                                child: SizedBox.fromSize(
                                  ...
                                  child: FadeInImage(
                                    image: NetworkImage(
                                        '${Environments.apiBaseURL}storage/images/' +
                                            value.savedInCart.packages![i].cover
                                                .toString()),
                                    placeholder: const AssetImage(
                                        "assets/images/placeholder.jpeg"),
                                    imageErrorBuilder:
