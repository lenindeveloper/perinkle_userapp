                            ...
                            child: RichText(
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text: ' ( ' +
                                        value.individualDetails.totalRating
                                            .toString() +
                                        ' ' +
                                        'Reviews)'.tr,
                                    style: const TextStyle(
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          Get.find<SpecialistController>().currencySide == 'left'
                                                                              ? Get.find<SpecialistController>().currencySymbol + '  ' + value.packagesList[index].price.toString()
                                                                              : '  ' + value.packagesList[index].price.toString() + Get.find<SpecialistController>().currencySymbol,
                                                                          style:
                                                                              const TextStyle(
                                                                            color:
                                                                                ThemeProvider.greyColor,
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        SizedBox(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            value.ownerReviewsList[index].user!.firstName! +
                                                                                ' ' +
                                                                                value.ownerReviewsList[index].user!.lastName!,
                                                                            overflow:
